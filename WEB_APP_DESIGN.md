...
- 老師蒸餾整合共三點：首頁 teachProfileCard、詳解區 teachBlock（老師這樣教＋口訣＋黑板答案）、AI 批改 prompt。資料在雲端 app_state（teachProfile＋teach 279 題，2026-07-10 驗證 205 對 extbank／74 對內建、零孤兒）。方法庫 1662 條未進 app（見 OPERATIONS 待辦）。
